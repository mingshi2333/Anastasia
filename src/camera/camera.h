...
public:
    ...
    auto setProjection(PerspectiveInfo perspectiveInfo) -> Camera&;
    auto setProjection(OrthographicInfo orthographicInfo) -> Camera&;
    auto setProjection(Mat4 value) -> Camera&;
    auto setLookAt(const Vec3& eye, const Vec3& center, const Vec3& up) -> Camera&;
