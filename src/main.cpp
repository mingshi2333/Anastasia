...
// {
//     std::ifstream file(
//         filename, std::ios::ate | std::ios::binary); // ate is read start at the end of the file to determine the size of the
//         file
...
//             vkCmdPipelineBarrier(commandBuffers, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_PIPELINE_STAGE_TRANSFER_BIT, 0, 0, nullptr,
//             0,
//                                  nullptr, 1, &barrier);
